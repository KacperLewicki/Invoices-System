      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        <div className="bg-white p-6 rounded-lg max-w-lg mx-auto">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-purple-700">Account Information</h2>
          </div>
          {user ? (
            <div className="space-y-4">
              <div className="flex justify-between">
                <strong className="text-purple-600 w-1/3">Name:</strong>
                <span className="w-2/3">{user.name}</span>
              </div>
              <div className="flex justify-between">
                <strong className="text-purple-600 w-1/3">Email:</strong>
