            ...
            {showConfirmation && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
                    <div className="bg-white rounded-lg shadow-lg p-6">
                        ...
                        <p className="mb-4 text-center">Twoja poprawiona faktura jest w zakładce -Poprawione Faktury- i jest w oczekiwaniu na akceptację.</p>
                        <button
                        ...
                        <div className="relative w-full ustify-end">
                            <div className="flex justify-end">
                                <button
                                    ...
                                    className="bg-purple-600 text-white py-1 px-1 rounded hover:bg-green-700"
                                >
                                    Dodaj Pozycję
                                </button>
                            </div>
